const data = {
  ...
  items: [{
    ...
    snippet: {
      ...
      // eslint-disable-next-line max-len
      localized: { title: 'Angular 8 - Быстрый курс за 60 минут', description: 'Полный курс по Angular 8+:\nhttps://clc.to/angular\n\nTelegram: https://teleg.one/js_by_vladilen \nInstagram: https://www.instagram.com/vladilen.minin \nVK: https://vk.com/vladilen.minin \nГруппа VK: https://vk.com/js_by_vladilen \n\nReact Native: мобильная разработка на JavaScript:\nhttps://clc.to/rnative\n\nПоддержать выпуск новых видео:\nЯД: https://money.yandex.ru/to/410013757655670\nPayPal: https://www.paypal.me/vladilenm \n\n30 мая 2019 года бы релиз Angular 8 и я решил записать  по нему быстрый курс. В видео вы узнаете, как Angular работает, как его установить.\nВ результате урока я покажу создание Todo приложения с разными подходами. Разберем работу с сервером, сервисами, пайпами, коммуникацией между компонентами и немного RxJS\n\nИсходный код:\nhttps://github.com/vladilenm/angular8-cc\n\nAngular 8 - Быстрый курс за 60 минут' },
      defaultAudioLanguage: 'en-US',
    },
    statistics: {
      viewCount: '33265', likeCount: '1173', dislikeCount: '26', favoriteCount: '0', commentCount: '170',
    },
  }, {
    kind: 'youtube#video',
    ...
    snippet: {
      ...
      thumbnails: {
        // eslint-disable-next-line max-len
        default: { url: 'https://i.ytimg.com/vi/Fdf5aTYRW0E/default.jpg', width: 120, height: 90 }, medium: { url: 'https://i.ytimg.com/vi/Fdf5aTYRW0E/mqdefault.jpg', width: 320, height: 180 }, high: { url: 'https://i.ytimg.com/vi/Fdf5aTYRW0E/hqdefault.jpg', width: 480, height: 360 }, standard: { url: 'https://i.ytimg.com/vi/Fdf5aTYRW0E/sddefault.jpg', width: 640, height: 480 }, maxres: { url: 'https://i.ytimg.com/vi/Fdf5aTYRW0E/maxresdefault.jpg', width: 1280, height: 720 },
      },
      ...
      liveBroadcastContent: 'none',
      // eslint-disable-next-line max-len
      localized: { title: 'Angular Crash Course', description: 'In this video we will talk about what Angular is and then jump in and build a small app With Angular 7, looking at most of the fundamental concepts like components, services, modules, etc\n\nSponsor:\nhttp://www.netlify.com\n\nCode:\nhttps://github.com/bradtraversy/angular-crash-todolist\n\n💖 Become a Patron: Show support & get perks!\nhttp://www.patreon.com/traversymedia\n\nWebsite & Udemy Courses\nhttp://www.traversymedia.com\n\nFollow Traversy Media:\nhttps://www.facebook.com/traversymedia\nhttps://www.twitter.com/traversymedia\nhttps://www.instagram.com/traversymedia' },
      defaultAudioLanguage: 'en',
    },
    statistics: {
      viewCount: '456979', likeCount: '8213', dislikeCount: '131', favoriteCount: '0', commentCount: '555',
    },
  }, {
    kind: 'youtube#video',
    ...
    snippet: {
      ...
      thumbnails: {
        // eslint-disable-next-line max-len
        default: { url: 'https://i.ytimg.com/vi/k5E2AVpwsko/default.jpg', width: 120, height: 90 }, medium: { url: 'https://i.ytimg.com/vi/k5E2AVpwsko/mqdefault.jpg', width: 320, height: 180 }, high: { url: 'https://i.ytimg.com/vi/k5E2AVpwsko/hqdefault.jpg', width: 480, height: 360 }, standard: { url: 'https://i.ytimg.com/vi/k5E2AVpwsko/sddefault.jpg', width: 640, height: 480 }, maxres: { url: 'https://i.ytimg.com/vi/k5E2AVpwsko/maxresdefault.jpg', width: 1280, height: 720 },
      },
      ...
      liveBroadcastContent: 'none',
      // eslint-disable-next-line max-len
      localized: { title: 'Angular Tutorial for Beginners: Learn Angular from Scratch | Mosh', description: '🔥Get the COMPLETE COURSE (60% OFF - LIMITED TIME): https://programmingwithmosh.com/courses/angular\n\nThis Angular tutorial teaches you the fundamentals of Angular and TypeScript.\n\nSUBSCRIBE FOR MORE VIDEOS!\nhttps://www.youtube.com/channel/UCWv7vMbMWH4-V0ZXdmDpPBA?sub_confirmation=1\n\n\nTABLE OF CONTENT \n\n00:00 Introduction\n02:54 What is Angular?\n04:54 Architecture of Angular Apps\n08:41 Setting Up the Development Environment\n11:25 Your First Angular App\n13:50 Structure of Angular Projects\n20:43 Webpack\n23:57 Angular Version History \n27:31 Course Structure\n31:55 TypeScript Fundamentals\n32:34 What is TypeScript?\n34:58 Your First TypeScript Program\n37:57 Declaring Variables\n42:46 Types\n48:29 Type Assertions\n51:15 Arrow Functions\n52:59 Interfaces\n56:54 Classes\n01:01:22 Objects\n01:05:31 Constructors\n01:08:22 Access Modifiers\n01:11:18 Access Modifiers in Constructor Parameters\n01:12:58 Properties\n01:18:15 Modules\n01:23:22 Angular Fundamentals\n01:23:41 Building Blocks of Angular Apps\n01:27:22 Creating Components\n01:37:00 Generating Components Using Angular CLI\n01:41:40 Templates\n01:44:08 Directives\n01:47:34 Services\n01:52:02 Dependency Injection\n01:59:22 Generating Services Using Angular CLI\n02:01:32 Exercise\n \n\nSTAY IN TOUCH\n\nhttps://www.facebook.com/programmingwithmosh/\nhttps://twitter.com/moshhamedani' },
      defaultAudioLanguage: 'en-US',
    },
    statistics: {
      viewCount: '1266085', likeCount: '18342', dislikeCount: '473', favoriteCount: '0', commentCount: '1255',
    },
  }, {
    kind: 'youtube#video',
    ...
    snippet: {
      ...
      thumbnails: {
        // eslint-disable-next-line max-len
        default: { url: 'https://i.ytimg.com/vi/Rf54BH35yrY/default.jpg', width: 120, height: 90 }, medium: { url: 'https://i.ytimg.com/vi/Rf54BH35yrY/mqdefault.jpg', width: 320, height: 180 }, high: { url: 'https://i.ytimg.com/vi/Rf54BH35yrY/hqdefault.jpg', width: 480, height: 360 }, standard: { url: 'https://i.ytimg.com/vi/Rf54BH35yrY/sddefault.jpg', width: 640, height: 480 }, maxres: { url: 'https://i.ytimg.com/vi/Rf54BH35yrY/maxresdefault.jpg', width: 1280, height: 720 },
      },
      channelTitle: 'Владилен Минин',
      // eslint-disable-next-line max-len
      ...
      liveBroadcastContent: 'none',
      // eslint-disable-next-line max-len
      localized: { title: 'Angular 8 Основы. Полный Курс для начинающих', description: 'Полный курс по Angular 8+:\nhttps://clc.to/angular\n\nДобавляйте меня в ВК: https://vk.com/vladilen.minin\nTelegram: https://teleg.one/js_by_vladilen\nInstagram: https://www.instagram.com/vladilen.minin\nГруппа ВК: https://vk.com/js_by_vladilen\n\nПоддержать выпуск новых видео:\nЯД: https://money.yandex.ru/to/410013757655670\nPayPal: https://www.paypal.me/vladilenm \n\nУрок по Angular. В этом курсе вы познакомитесь со всеми основными элементами, которые есть в Angular с полного нуля\n\nAngular 8 Основы. Полный Курс. Урок для Новичков' },
      defaultAudioLanguage: 'en-US',
    },
    statistics: {
      viewCount: '14544', likeCount: '573', dislikeCount: '11', favoriteCount: '0', commentCount: '88',
    },
  }, {
    kind: 'youtube#video',
    ...
    snippet: {
      ...
      thumbnails: {
        // eslint-disable-next-line max-len
        default: { url: 'https://i.ytimg.com/vi/m0yGx2MGZWg/default.jpg', width: 120, height: 90 }, medium: { url: 'https://i.ytimg.com/vi/m0yGx2MGZWg/mqdefault.jpg', width: 320, height: 180 }, high: { url: 'https://i.ytimg.com/vi/m0yGx2MGZWg/hqdefault.jpg', width: 480, height: 360 }, standard: { url: 'https://i.ytimg.com/vi/m0yGx2MGZWg/sddefault.jpg', width: 640, height: 480 }, maxres: { url: 'https://i.ytimg.com/vi/m0yGx2MGZWg/maxresdefault.jpg', width: 1280, height: 720 },
      },
      ...
      defaultLanguage: 'ru',
      // eslint-disable-next-line max-len
      localized: { title: 'Что такое Angular. Обзор возможностей', description: 'В этом видео речь пойдет про javascript фреймворк Angular. Я расскажу что такое Angular, где и когда его применяют, а так же сделаю небольшой обзор его возможностей. Расскажу чем фреймворк сложен для новичков и чем он действительно хорош для новых проектов. Сейчас для того что б стать junior javascript разработчиком нужно обязательно знать хотя бы один фреймворк js и ангуляр будет отличным выбором.' },
      defaultAudioLanguage: 'ru',
    },
    statistics: {
      viewCount: '43470', likeCount: '1047', dislikeCount: '198', favoriteCount: '0', commentCount: '96',
    },
  }, {
    kind: 'youtube#video',
    ...
    snippet: {
      ...
      thumbnails: {
        // eslint-disable-next-line max-len
        default: { url: 'https://i.ytimg.com/vi/u1VCxpvDgsk/default.jpg', width: 120, height: 90 }, medium: { url: 'https://i.ytimg.com/vi/u1VCxpvDgsk/mqdefault.jpg', width: 320, height: 180 }, high: { url: 'https://i.ytimg.com/vi/u1VCxpvDgsk/hqdefault.jpg', width: 480, height: 360 }, standard: { url: 'https://i.ytimg.com/vi/u1VCxpvDgsk/sddefault.jpg', width: 640, height: 480 }, maxres: { url: 'https://i.ytimg.com/vi/u1VCxpvDgsk/maxresdefault.jpg', width: 1280, height: 720 },
      },
    ...
    snippet: {
      ...
      liveBroadcastContent: 'none',
      // eslint-disable-next-line max-len
      localized: { title: 'Angular 40 вопросов для собеседования', description: 'Полный курс по Angular 8+:\nhttps://clc.to/angular\n\nДобавляйте меня в ВК: https://vk.com/vladilen.minin\nГруппа ВК: https://vk.com/js_by_vladilen\nTelegram: https://teleg.one/js_by_vladilen\nInstagram: https://www.instagram.com/vladilen.minin\n\nПоддержать выпуск новых видео:\nЯД: https://money.yandex.ru/to/410013757655670\nPayPal: https://www.paypal.me/vladilenm \n\nAngular 40 вопросов для собеседования. Подготовка к интервью' },
      defaultAudioLanguage: 'en-US',
    },
    statistics: {
      viewCount: '6824', likeCount: '595', dislikeCount: '10', favoriteCount: '0', commentCount: '126',
    },
  }, {
    kind: 'youtube#video',
    ...
    snippet: {
      ...
      liveBroadcastContent: 'none',
      // eslint-disable-next-line max-len
      localized: { title: 'Angular 8 + RxJS. Приложение Органайзер С Нуля (Для Опытных!)', description: 'Курс по Angular 8+: \nhttps://clc.to/angular \n\nДобавляйте меня в ВК: https://vk.com/vladilen.minin\nTelegram: https://teleg.one/js_by_vladilen\nInstagram: https://www.instagram.com/vladilen.minin\nГруппа ВК: https://vk.com/js_by_vladilen\n\nПоддержать выпуск новых видео:\nЯД: https://money.yandex.ru/to/410013757655670\nPayPal: https://www.paypal.me/vladilenm \n\nВ видео я покажу разработку приложения органайзера с нуля.\nВ видео я не буду пояснять базовые моменты, так как это практика для опытных разработчиков\n\nВ результате вы получите приложение, в котором будет использоваться много RxJS, Firebase, MomentJS и Angular 8\nНе будет никаких CSS фреймворков - все стили будут написаны с нуля с использованием CSS переменных\n\nИсходный код:\nhttps://github.com/vladilenm/angular-organizer\n\nAngular 8 + RxJS. Приложение Целиком (Для Опытных!)\nhttps://youtu.be/NaZwVUHnmfE' },
      defaultAudioLanguage: 'en-US',
    },
    statistics: {
      viewCount: '12128', likeCount: '665', dislikeCount: '11', favoriteCount: '0', commentCount: '156',
    },
  }, {
    kind: 'youtube#video',
    ...
    snippet: {
      ...
      thumbnails: {
        // eslint-disable-next-line max-len
        default: { url: 'https://i.ytimg.com/vi/G0bBLvWXBvc/default.jpg', width: 120, height: 90 }, medium: { url: 'https://i.ytimg.com/vi/G0bBLvWXBvc/mqdefault.jpg', width: 320, height: 180 }, high: { url: 'https://i.ytimg.com/vi/G0bBLvWXBvc/hqdefault.jpg', width: 480, height: 360 }, standard: { url: 'https://i.ytimg.com/vi/G0bBLvWXBvc/sddefault.jpg', width: 640, height: 480 }, maxres: { url: 'https://i.ytimg.com/vi/G0bBLvWXBvc/maxresdefault.jpg', width: 1280, height: 720 },
      },
      ...
      liveBroadcastContent: 'none',
      // eslint-disable-next-line max-len
      localized: { title: "Angular for Beginners - Let's build a Tic-Tac-Toe PWA", description: 'Learn the basics of Angular 8 🚀 by building a tic-tac-toe game 🕹️ from scratch...Then deploy it as an installable progressive web app (PWA). Go beyond the basics 👉https://fireship.io/courses/angular/\n\nFull Source Code: https://github.com/fireship-io/angular-tic-tac-toe\nAngular Docs: https://angular.io/\n\n#angular #pwa #tutorial\n\nTake Angular quizzes 🤓\n\niOS https://itunes.apple.com/us/app/fireship/id1462592372?mt=8\nAndroid https://play.google.com/store/apps/details?id=io.fireship.quizapp\n\nUpgrade to Fireship PRO at https://fireship.io/pro\nUse code lORhwXd2 for 25% off your first payment.' },
      defaultAudioLanguage: 'en',
    },
    statistics: {
      viewCount: '56657', likeCount: '2092', dislikeCount: '36', favoriteCount: '0', commentCount: '128',
    },
  }],
};
